...
import dush.framework.framework as framework
from dush.utils.os_function import is_windows, windows_only
from dush.utils.paths import RaiiChdir
...
def run_command(
    ...
    *,
    ...
    if framework.get_framework_args().verbose:
